      ...
      <main className="pb-10">
        ...
        >
          ...
          >
            ...
            <p className="text-[#ffffbc] text-base md:text-xl max-w-2xl drop-shadow-[0_0_8px_rgba(0,0,0,0.9)] mb-6">
              O melhor lugar para decorar o quartinho do seu bebê com carinho e
              segurança.
            </p>
        ...
        >
          ...
          <p className="text-[#313b2f] text-lg max-w-2xl mx-auto mb-10 leading-relaxed">
            Veja nossos produtos mais vendidos e encontre o item perfeito para o
            seu lar.
          </p>
        ...
        >
          <h2 className="text-[#313b2f] text-3xl font-bold mb-6 ">Whatsapp</h2>
        ...
        <motion.section
          ...
          variants={slideInRight}
        >
          <h2 className="text-[#313b2f] text-3xl font-bold mb-4 ">Instagram</h2>
