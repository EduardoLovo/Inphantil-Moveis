/*
  ...
  - The values [LENÇOL] on the enum `VisualItemType` will be removed. If these variants are still used in the database, this will fail.

*/
-- AlterEnum
BEGIN;
CREATE TYPE "VisualItemType_new" AS ENUM ('APLIQUE', 'TECIDO', 'PANTONE', 'LENCOL', 'SINTETICO', 'SHOWROOM');
